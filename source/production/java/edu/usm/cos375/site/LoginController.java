...
public class LoginController
{
    ...
    static {
		userDatabase.put("Caleb", "password");
		userDatabase.put("Sarah", "wordpass");
		userDatabase.put("Rick", "snoopy");
		userDatabase.put("Morty", "blooples");
	} 
    ...
    public ModelAndView login(Map<String, Object> model, HttpSession session)
    {
        if(session.getAttribute("username") != null)
            return this.getLocationRedirect();
    ...
    private ModelAndView getLocationRedirect()
    {
        return new ModelAndView(new RedirectView("/location/list", true, false));
    }
